...
public class PoliticalGroupConfig {
	...
	CommandLineRunner commandLineRunner2(PoliticalGroupRepository politicalGroupRepository) 
	{
		return args -> 
		{
			...
			PoliticalGroup pvda = new PoliticalGroup("pvda", pvdaMembers, PoliticalGroupAlignment.LINKS);
			...
			PoliticalGroup pvv = new PoliticalGroup("pvv", pvvMembers, PoliticalGroupAlignment.RECHTS);
